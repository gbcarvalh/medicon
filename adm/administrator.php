...
<body>
					...
					<div class="panel-group" style="width: 30%; margin: 1em; padding: 1.5em 1em; border: 1px solid #aaaaaa; border-radius: 4px; background-color: #1b7694;">
						<div class="panel panel-default">
							...
							<div id="collapse1" class="panel-collapse collapse">
								<ul class="list-group">
									<li class="list-group-item"><a href="doctor/register_doctor.php" style="text-decoration:none; color: black; text-style: center;">Cadastrar</a></li>
									<li class="list-group-item"><a href="doctor/search_doctor.php" style="text-decoration:none; color: black; text-style: center;">Pesquisar</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="panel-group" style="width: 30%; margin: 1em; padding: 1.5em 1em; border: 1px solid #aaaaaa; border-radius: 4px; background-color: #1b7694;">
						<div class="panel panel-default">
							...
							<div id="collapse2" class="panel-collapse collapse">
								<ul class="list-group">
									<li class="list-group-item"><a href="patient/register_patient.php" style="text-decoration:none; color: black; text-style: center;">Cadastrar</a></li>
									<li class="list-group-item"><a href="patient/search_patient.php" style="text-decoration:none; color: black; text-style: center;">Pesquisar</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="panel-group" style="width: 30%; margin: 1em; padding: 1.5em 1em; border: 1px solid #aaaaaa; border-radius: 4px; background-color: #1b7694;">
						<div class="panel panel-default">
							...
							<div id="collapse3" class="panel-collapse collapse">
								<ul class="list-group">
									<li class="list-group-item"><a href="plan/register_plan.php" style="text-decoration:none; color: black; text-style: center;">Cadastrar</a></li>
									<li class="list-group-item"><a href="plan/search_plan.php" style="text-decoration:none; color: black; text-style: center;">Pesquisar</a></li>
								</ul>
							</div>
						</div>
					</div>
	...
	<script src="<?php print $url ?>/https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCIwF204lFZg1y4kPSIhKaHEXMLYxxuMhA"></script>
