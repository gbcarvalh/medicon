...
<head>
	<title>Pesquisar Convênios</title>
	<meta charset="utf-8">
				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form">
							<div class="contact_title"> Pesquisa de Convêncio</div>
							<div class="contact_form_container">
								<form method="post" action="search_plan.php" id="contact_form" class="contact_form">
								...
								if ($stm->execute()) {
									...
									print "<th scope='col'>Ações</th></tr></thead>";
									while ($row = $stm->fetch()) {
										$id = $row['id'];
										$name = $row['name'];

										print "<thead class='thead-light'><tr><td>$name</td>";
										print "<td>|<a href='delete_plan.php?id=$id'> Excluir </a>|";
										print "<a href='edit_plan.php?id=$id&name=$name'>";
										print " Editar </a>|</td></tr></thead>";
									}
									print "</table>";
								} else {
									print '<p>Erro ao listar convênios!</p>';
								}
								?>
							</div>
						</div>
