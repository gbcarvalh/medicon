				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form">
							<div class="contact_title"> Cadastro de Médicos</div>
							<div class="contact_form_container">
								<form method="post" action="save_doctor.php" id="contact_form" class="contact_form">
									<input type="text" id="contact_input" class="contact_input" placeholder="Nome" required="required" name="name">
									<input type="text" id="contact_input" class="contact_input" placeholder="Contato" required="required" name="contact">
									<input type="text" id="contact_input" class="contact_input" placeholder="Endereço" required="required" name="localization">
									<input type="text" id="contact_input" class="contact_input" placeholder="Cidade" required="required" name="idtown">
									<button type="submit" class="contact_button" id="contact_button">Cadastrar</button>
								</form>
							</div>
						</div>
					</div>
