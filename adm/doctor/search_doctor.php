					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form">
							...
							<div class="contact_form_container">
								<form method="post" action="search_doctor.php" id="contact_form" class="contact_form">
								...
								if ($stm->execute()) {
									...
									print "<th scope='col'>Endereço</th>
									...
									while ($row = $stm->fetch()) {
										...
										print "<thead class='thead-light'><tr><td>$name</td><td>$contact</td>";
										print "<td>$localization</td><td>$idtown</td>";
										print "<td>|<a href='delete_doctor.php?id=$id'> Excluir </a>|";
										print "<a href='edit_doctor.php?id=$id&name=$name&contact=$contact";
										print "&localization=$localization&idtown=$idtown'>";
