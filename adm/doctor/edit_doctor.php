					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Atualizar informações</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form">
							<div class="contact_title"> Atualização de Médicos</div>
							<div class="contact_form_container">
								<form method="post" action="update_doctor.php" id="contact_form" class="contact_form">
									<?php print "<input type='hidden' name='id' value='$id'/>"; ?>
									<?php print "<input type='text' id='contact_input' class='contact_input' placeholder='Nome' required='required' name='name' value='$name'/>"; ?>
									<?php print "<input type='text' id='contact_input' class='contact_input' placeholder='Contato' required='required' name='contact' value='$contact'/>"; ?>
									<?php print "<input type='text' id='contact_input' class='contact_input' placeholder='Endereço' required='required' name='localization' value='$localization'/>"; ?>
									<?php print "<input type='text' id='contact_input' class='contact_input' placeholder='Cidade' required='required' name='idtown' value='$idtown'/>"; ?>
									<button type="submit" class="contact_button" id="contact_button">Atualizar cadastro</button>
								</form>
