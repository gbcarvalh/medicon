				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form">
							<div class="contact_title">Edição de Pacientes</div>
							<div class="contact_form_container">
								<form method="post" action="update_patient.php" id="contact_form" class="contact_form">
									...
									<?php print "<input type='text' id='contact_input' class='contact_input' placeholder='Email' required='required' name='email' value='$email'/>"; ?>
									<?php print "<input type='text' id='contact_input' class='contact_input' placeholder='CPF' required='required' name='cpf' value='$cpf'/>"; ?>
