				...
				<div class="row">
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form">
							<div class="contact_title"> Cadastro de Pacientes</div>
							<div class="contact_form_container">
								<form method="post" action="save_patient.php" id="contact_form" class="contact_form">
									<input type="text" id="contact_input" class="contact_input" placeholder="Nome" required="required" name="name">
									<input type="text" id="contact_input" class="contact_input" placeholder="Email" required="required" name="email">
									<input type="text" id="contact_input" class="contact_input" placeholder="Senha" required="required" name="passwd">
									<input type="text" id="contact_input" class="contact_input" placeholder="CPF" required="required" name="cpf">
