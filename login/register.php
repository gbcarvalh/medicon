...
<body>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-sm-12 contact_col" style="margin: 0 auto;">
						<div class="info_form_container">
							<div class="info_form_title">Cadastre-se como paciente</div>


							<form method= "post" action="save_patient.php" class="info_form" id="info_form">
								<input type="text" class="info_input" placeholder="CPF" required="required" name="code">
								<input type="password" class="info_input" placeholder="Senha" name="senha">
								<input type="password" class="info_input" placeholder="Confirme sua senha" name="conf-senha">

								<select class="info_input" onchange="carregaCidades(this.value, '#cidade1')" name="estado">
									<option>Selecione...</option>
									<?php
										# SQL para buscar fabricantes
								...
								<select id='cidade1' class="info_input" name="cidade">

								</select>

								<button type="submit" class="info_form_button">Registrar</button>
							</form>


							<br>
							<div class="ml-auto" style="color: black; text-align:center;">Já possui conta? <a href="login.php">Faça login</a></div>
						</div>
					</div>
					...
					<div class="col-lg-6 col-sm-12 contact_col" style="margin: 0 auto;">
						<div class="info_form_container">
							<div class="info_form_title">Cadastre-se como médico</div>
							<form method= "post" action="save_doctor.php" class="info_form" id="info_form">
								<input type="text" class="info_input" placeholder="CRM" required="required" name="code">
								<input type="password" class="info_input" placeholder="Senha" required="required" name="senha">
								<input type="password" class="info_input" placeholder="Confirme sua senha" required="required" name="conf-senha">

								<select class="info_input" onchange="carregaCidades(this.value, '#cidade2')" required="required" name="estado">
									<option>Selecione...</option>
									<?php
										# SQL para buscar fabricantes
										$query = "SELECT * FROM state";
								...
								<select id='cidade2' class="info_input" required="required" name="cidade">

								</select>

								<input type="text" class="info_input" placeholder="Endereço" required="required" name="localization">
								<input type="text" class="info_input" placeholder="Contato" required="required" name="contact">
	...
	<script>
		function carregaCidades(stateId, idEl){
			$.post( "retrievecities.php", { 	'id': stateId })
				.done(function( data ) {
					$(idEl).html(data);
			});
		}
